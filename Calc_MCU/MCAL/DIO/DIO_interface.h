...
#define PORT_C								(u8)3
#define PORT_D								(u8)4
/** Description: this is the pin numbers when you want to use the driver. **/
#define P_0									(u8)0
#define P_1									(u8)1
#define P_2									(u8)2
#define P_3									(u8)3
...
/***************************Definitions for DIO_SetPinDir and DIO_SetPortDir****************/
...
/***************************Definitions for DIO_SetPinValue and DIO_SetPortValue****************/
